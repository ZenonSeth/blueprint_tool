...
local function build_main_formspec(playerName, itemstack)
  ...
  if slot_idx then
    ...
    slot_label = minetest.colorize(blueprint_tool.COLOR_WARN, "No Slot Available")
  end
  ...
  if pos1 and pos2 then
    ...
    face_btns =
      face_group(4.7,  y1, "Front:", "ft_front_minus", "ft_front_plus")..
      face_group(7.7,  y1, "Top:",   "ft_up_minus",    "ft_up_plus")..
      face_group(10.7, y1, "Left:",  "ft_left_minus",  "ft_left_plus")..
      face_group(4.7,  y2, "Back:",  "ft_back_minus",  "ft_back_plus")..
      face_group(7.7,  y2, "Bottom:","ft_down_minus",  "ft_down_plus")..
      face_group(10.7, y2, "Right:", "ft_right_minus", "ft_right_plus")..
      "label[4.7,1.85;Size: "..minetest.formspec_escape(size_str).."]"
  end
...
local function build_analysis_formspec(playerName, analysis, show_capture_btn)
  ...
  if show_capture_btn then
    ...
    fs = fs.."button[4.4,"..btn_y..";3.8,0.7;analysis_back;Back]"
  else
    fs = fs.."button[2.5,"..btn_y..";3.5,0.7;analysis_back;Back]"
  end
